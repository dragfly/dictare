...
export const HIDDEN_FORM_FIELDS = new Set(["audio.silence_ms", "daemon.socket_path", "editor", "hotkey.device", "keyboard.shortcuts", "logging.log_file", "output.auto_submit", "output.newline_keys", "output.submit_keys", "output.typing_delay_ms", "redact", "stats.typing_wpm", "stt.model", "stt.translate", "tts.engine", "tts.speed"]);
...
export const FIELD_PRESETS: Record<string, PresetOption[]> = {
  ...
  "stt.model": ["large-v3-turbo", "large-v3", "parakeet-v3"],
