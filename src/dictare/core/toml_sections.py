...
def serialize_section(section: str, config: Config) -> str:  # noqa: ARG001
    ...
    """
    from dictare.config import get_config_path
...
def _validate_section(section: str, content: str) -> None:
    ...
    if section == "agent_types":
        ...
        from dictare.config import AudioAdvancedConfig
        ...
        from dictare.config import STTAdvancedConfig
        ...
        from dictare.config import SoundConfig
        ...
        from dictare.config import AgentFilterConfig
