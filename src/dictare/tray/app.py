...
class TrayApp:
    ...
    def _on_open_accessibility_settings(
        ...
        from dictare.platform.permissions import open_accessibility_settings
    ...
    def _on_open_microphone_settings(
        ...
        from dictare.platform.permissions import open_microphone_settings
    ...
    def _on_open_input_monitoring_settings(
        ...
        from dictare.platform.permissions import open_input_monitoring_settings
...
def main() -> None:
    ...
    try:
        ...
        print("Install with: pip install dictare[tray]", file=sys.stderr)
        sys.exit(1)

    from dictare import __version__
    from dictare.config import load_config
    from dictare.logging.setup import get_default_log_path, setup_logging
    from dictare.tray.lifecycle import remove_pid, write_pid
    ...
    # The engine (running inside Dictare.app via the Swift launcher) handles all
