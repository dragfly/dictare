...
class DictareJsonFormatter(JsonFormatter):
    """Custom JSON formatter for dictare logs.
...
def setup_logging(
    ...
    Args:
        ...
        source: Process identifier (e.g., "engine", "tray") added to
                every log entry. Used by ``dictare logs --source`` to
...
def shutdown_logging() -> None:
    ...
    """
    logger = logging.getLogger("dictare")
