"""Plugin protocol and base classes for voxtype plugins."""
...
class Plugin(Protocol):
    """Protocol for voxtype plugins.

    Plugins can add CLI commands and access voxtype services (STT, TTS, etc.).
    """

    @property
    def name(self) -> str:
        """Plugin name (used as CLI subcommand: voxtype <name> ...).
