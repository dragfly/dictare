...
- **Double Ctrl+C semaphore leak**: Pressing Ctrl+C twice quickly no longer causes "leaked semaphore objects" warning. The multiprocessing resource tracker is now properly stopped before force exit.
