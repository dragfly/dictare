...
- PTY injection now writes character-by-character (3ms delay) instead of all at once
- Prevents Claude Code from dropping input when receiving large text blocks
